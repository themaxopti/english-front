            ...
            <div className="section__content section__content_p" style={{ display: 'flex', flexDirection: 'column' }}>
                <div className={s["approach"]}>
                    <div className={s['approach__cards']}>
                        <motion.h2 custom={0.5} variants={show}>Чем мой подход отличается от других?</motion.h2>

                        <motion.div custom={1} variants={show} className={s["approach__card"]}>
                        ...
                        <motion.div custom={1.1} variants={show} className={s["approach__card"]}>
                        ...
                        <motion.div custom={1.2} variants={show} className={s["approach__card"]}>
                        ...
                        <motion.div custom={1.3} variants={show} className={s["approach__card"]}>
                        ...
                        <motion.div custom={1.4} variants={show} className={s["approach__card"]}>
