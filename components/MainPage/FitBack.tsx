            ...
            <div className="section__content section__content_p">
                <div className={s['fit-back']}>
                    <div className={s["fit-back__card"]}>
                        <motion.div custom={1.1} variants={sideAnimation(-100)} className={s['fit-back__title']}>Мой опыт подготовки людей:</motion.div>
                        <motion.div custom={1.2} variants={sideAnimation(100)} className={s["fit-back__text"]}>Это мой первый поток подготовки студентов к сдачи IELTS, но я индивидуально подготовила 2х студентов к сдачи IELTS на 6,5 и на 7.0, также я самостоятельно готовилась к сдачи этого теста для поступления заграницу и прошла этот путь на своём примере.</motion.div>
                    </div>
                    <div className={s["fit-back__card"]}>
                        <motion.div custom={1.2} variants={sideAnimation(-100)} className={s['fit-back__title']}>Почему именно мои курсы помогут Вам?</motion.div>
                        <motion.div custom={1.3} variants={sideAnimation(100)}  className={s["fit-back__text"]}>Во время бакалавриата на
                    ...
                    <div className={s["fit-back__card"]}>
                        <motion.div custom={1.2} variants={sideAnimation(-100)}  className={s['fit-back__title']}>Эффективны ли занятия в группе?</motion.div>
                        <motion.div custom={1.3} variants={sideAnimation(-100)}  className={s["fit-back__text"]}>
                    ...
                    <div className={s["fit-back__card"]}>
                        <motion.div custom={1.4} variants={sideAnimation(-100)}  className={s['fit-back__title']}>Удобно ли в онлайн-формате ?</motion.div>
                        <motion.div custom={1.5} variants={sideAnimation(-100)}  className={s["fit-back__text"]}>
                    ...
                    <div className={s["fit-back__card"]}>
                        <motion.div custom={1.6} variants={sideAnimation(-100)}  className={s['fit-back__title']}>Достаточный ли у Вас уровень языка?</motion.div>
                        <motion.div custom={1.7} variants={sideAnimation(100)}  className={s["fit-back__text"]}>
