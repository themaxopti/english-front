...
import { textAnimation, imgAnimation } from './motion'
...
export const FirstPage: NextPage = () => {
    ...
    return (
        <motion.div viewport={{ once: true }} initial="hidden" whileInView="visible" className='section section_fullscren' ref={ref} style={{ overflow: 'hidden' }}>
            ...
            <motion.img viewport={{ once: true }} initial="hidden" whileInView="visible" custom={1} variants={imgAnimation} className={s['rectangle']} src="/images/Rectangle.svg" alt="" />

            <motion.div className="section__content section__content_p">
                <div className={s["first-page"]}>
                    <motion.h1
                        custom={1} variants={textAnimation} className={s['first-page__h']}
                    >
                    ...
                    <motion.div
                        ...
                        custom={1.1} variants={textAnimation}
                        whileTap={{ scale: 0.9 }}
                    >
