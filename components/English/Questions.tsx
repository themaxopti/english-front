    ...
    return (
        <motion.div viewport={{ once: true }} initial="hidden" whileInView="visible" className='section' style={{background:'#FFE6B3'}}>
            <div className="section__content section__content_p">
                <div>
                    <motion.img custom={0.5} variants={useSideAnimation(400)} className={s["rect-circle"]} src="/images/english-circle.svg" alt="" />
                    <motion.img custom={0.7} variants={useSideAnimation(-400)} className={s["rect-circle"]} src="/images/english-circle.svg" alt="" />
                </div>


                <div className={s["questions"]}>
                    <div className={s["questions__wrap"]}>
                        <motion.div custom={0.8} variants={useSideAnimation(400)}><h2>Часто задаваемые вопросы</h2></motion.div>

                        <motion.div custom={0.9} variants={useSideAnimation(-400)} className={s["questions__card"]} style={{ marginTop: '30px' }}>
                        ...
                        <motion.div custom={0.9} variants={useSideAnimation(-400)} className={s["questions__card"]}>
