        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} className='section'>
            ...
            <div className="section__content section__content_p">
                <div className={s["ielts-questions"]}>
                    <motion.div custom={0.5} variants={sideAnimation(-100)} className={s["ielts-questions__tag"]}>Часто задаваемые вопросы</motion.div>
                    <div className={s["ielts-questions__wrap"]}>
                        <motion.div custom={1.1} variants={sideAnimation(200)} className={s["ielts-questions__question"]}>
                        ...
                        <motion.div custom={0.6} variants={sideAnimation(200)} className={s["ielts-questions__question"]}>
                        ...
                        <motion.div custom={0.8} variants={sideAnimation(200)} className={s["ielts-questions__question"]}>
